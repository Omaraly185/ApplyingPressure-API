...
"Hello ${name}, thank you for choosing us for your detail appointment. This is Omar from Applying Pressure Mobile Detailing. Confirming your booking for ${ExteriorPackage} and ${interiorPackage} detailing on your ${carType}. Scheduled for ${selectedDate} ${selectedTime} at ${location}. Does that sound about right?
`,
    });
    await sendMail({
      to: email,
